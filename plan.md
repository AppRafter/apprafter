...
**Поставка (подфазы; закрыты только a и b):**
...
- [ ] **(d) Xref + health-метрики** *(= W3)*. Xref-теги, явные `{#anchor}`-id, типизированные `verified-by`-биндинги, `.test-index.json`, `# docs:`-заголовки в walk'ах, коммитнутый `docs/.docs-health.json` + три ратчета.
