...
- [ ] **2.20b — гейт `recipe-purity`**, красный на текущем корпусе, с фикстурой на страницу
  худшего тира. Чужой вызов вне свёрнутого блока, вне troubleshooting/recovery и вне
  аллоулиста — находка. Переиспользует типизированный канал исключений из `marker.rs`.
