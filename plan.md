...
- [~] **2.23n — сам свип: механика уезжает в how-it-works** · docs-only, самый большой; **после 2.23i**
  ...
  - [x] Блокер снят вместе с распилом node-prep: `kubectl rollout restart` учит `kubectl rollout restart` на
        ...
        случай.
  - [~] **Ход свипа.** Готовы три страницы механики из шести: GitOps + CUE-плагин (её не было
  ...
  - [ ] Остаток: три страницы механики (shared volumes, апгрейд платформы, digest + per-env
        deploy), распил `migration-plans.md`, и последние семь цитат за ними.
