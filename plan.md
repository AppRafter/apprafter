...
- [ ] **2.23g — CI следит за версиями внешних компонентов** · CI-only, без bump
  - [ ] Автоматики нет никакой: ни `dependabot.yml`, ни Renovate, ни одной из **28** workflow,
  ...
  - [ ] **Решение владельца (2026-09-05): свой скрипт, а не бот.** Формулировка владельца —
  ...
  - [ ] Форма: **один инвентарь, один читатель, один отчёт.** Инвентарь пинов — данные
        ...
        и просила находка.
  - [ ] Второй этап — то, ради чего это вообще стоит писать самим: **попытаться прогнать тесты
  ...
  - [ ] **Не заводить override версий через env.** `cli-providers/build.rs` осознанно делает CUE
  ...
  - [ ] Границы: **ноль автомержа и ноль автокоммитов**. Отчёт — вход для человека. Первопартийные
