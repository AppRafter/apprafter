...
**Acceptance:**
- [ ] **(CI-gate, pending first green)** `just e2e` (= `gitops-walk.sh`) runs green on k3d in CI; `mvp.sh` green in nightly. This is the M1.5 closure verification — flips §6 M1.5 box on the first green `e2e-k3d` run.
