...
- [ ] **a. cue-cmp: discovery по repo-relative пути + контенту, рендер всех каталогов пакета,
      отказ на неконсистентный бандл.** Измерено: четыре раскладки сегодня либо тихо прунят
