...
- [ ] **(g) Публикация** *(= W6)*. Свой образ + Caddyfile, `docs-autotag`/`release-docs` с негативным path-фильтром, `Application.cue`, зона, `docsUrl` в CMS и `Header.astro` → сайт живёт на финальных URL'ах, «Soon»-бейдж снимается.
