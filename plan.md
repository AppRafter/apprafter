...
- [ ] **(e) mkdocs-хуки** *(= W4)*. Pygments-лексер для CUE, валидация frontmatter, генерация `llms.txt` / `llms-full.txt`.
