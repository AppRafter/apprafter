...
- [ ] **`operator-guide/quickstart.md` — самая плотная механика из оставшихся** в обоих деревьях
      гайдов: таблица закреплённых версий компонентов, разбор трёх фаз и mermaid-диаграмма того,
      что ставит `cluster-bootstrap`.
- [ ] **Секция ёмкости в `shared-volumes.md`** (25 строк контроллерных внутренностей), при том
      что её же страница механики возвращает тему обратно в гайд.
