...
- [ ] **(j) Закрытие** *(= W9)*. Ручная прогулка по КАЖДОМУ гайду; `FEATURE_TRACKER.md` / `plan.md` / `plan-history.md`; ADR 0057 актуализирован по факту поставки c–i.
