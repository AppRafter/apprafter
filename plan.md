...
- [ ] **2.23p — деплой как разобранный пример** · docs-only
  - [ ] Ранбук публикации — пять шагов, из которых четыре родовые («приложение на поддомене») и
  ...
  - [ ] Две новые страницы в `how-it-works/`: как задеплоен сайт документации и как задеплоены
  ...
  - [ ] Каждая страница: что именно деплоится и где живёт; **таблица «что за что отвечает и откуда
  ...
  - [ ] Цепочка лендинга — пять потоков образов, четыре workflow, три манифеста и **ни одной
  ...
  - [ ] Список редакции — обязателен: креды, внутренние хостнеймы, всё, что запрещает правило
        гигиены `docs/`.
