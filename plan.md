...
> Страница 204 → 177 строк; 47 → 59 строк данных; блокквот-проза 965 → 125 слов; ноль → 15
> ячеек-ссылок. Перепись: invocations 589 → 573, identifiers 340 → 334, code paths 135 → 133,
> ADR refs 59 → 55, exemptions 7 → 5 — всё это удалённая релизная проза блокквот и два
> `cli-check-ignore` на команды, которых нестроенные строки больше не называют.
