...
- [ ] **2.23q — вернуть 2.21 то, чего у неё нет: план** · передача, не исполнение
  - [ ] **Поправка к посылке:** переписывание статусной страницы принадлежит **2.21b**, а не 2.22 —
  ...
  - [ ] Спека **жива и полна**: `docs/superpowers/specs/2026-08-29-public-feature-ledger-design.md`,
  ...
  - [ ] Состояние страницы измерено и не изменилось структурно с базовой линии FEATURE_TRACKER:
  ...
  - [ ] Честный учёт того, что 2.23f сделала здесь **хуже**: она добавила десять строк в старой
        пятиколоночной форме и свежее описание внутреннего процесса — то есть слегка увеличила
        объём работы 2.21b.
  - [ ] Шаг 2.23: не переписывать страницу здесь, а **написать план по выжившей спеке** и поднять
