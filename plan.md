...
- [ ] **2.23n — сам свип: механика уезжает в how-it-works** · docs-only, самый большой; **после 2.23i**
  ...
  - [ ] Маршрутизация всех 53 цитат разобрана поимённо: **5** — механика, переезжает целиком;
        ...
        **у 29 из них назначения ещё не существует**. Это и есть порядок работ: страницы прежде
        ссылок.
  - [ ] **Ловушка, которую надо снять в этом же изменении:** `behaviour-claim` — единственный класс
        ...
        охранника.
  - [ ] Известный блокер внутри свипа: `node-prep.md:86` учит `kubectl rollout restart` на
