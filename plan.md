...
- [x] **2.23n — сам свип: механика уезжает в how-it-works** · docs-only, самый большой; **после 2.23i**
  - [ ] Масштаб измерен: **53 из 90** ADR-цитат корпуса (59%) сидят в двух рецептных деревьях, на
        ...
        начинается.
  - [ ] Шесть новых страниц `how-it-works/`, в порядке «дешевле и изолированнее — раньше»:
  ...
  - [ ] Маршрутизация всех 53 цитат разобрана поимённо: **5** — механика, переезжает целиком;
