...
- [ ] **2.23f — хром сайта документации** · docs-only
  - [ ] Пугающий баннер на старте — это не наш дев-сервер, а протестное уведомление
  ...
  - [ ] **Дыра в доставке, найденная при разборе:** `overrides/**` не входит в path-фильтры ни
  ...
  - [ ] Лого и favicon: `mkdocs.yml` не задаёт ни `theme.logo`, ни `theme.favicon`, поэтому в
  ...
  - [ ] 23 ссылки на **10** файлах (не 12) показывают имя файла с `.md` как видимый текст, хотя href
  ...
  - [ ] Plausible как на лендинге — **решение владельца (2026-09-05): подключать**. Штатный путь
  ...
  - [ ] Политика приватности правится **вместе** с подключением, и правится по существу, а не
  ...
  - [ ] Мелкая блок-схема на `dev-guide/application-cue/#field-reference`: `flowchart LR` из
  ...
  - [ ] `docs/status.md` переписать. Две строки застряли в состоянии ветки («awaiting push»,
